...
-- R10
CTA_MONITOR_CHANNEL_NAME = { ["LOOKINGFORGROUP"] = true, ["WORLD"] = true, ["GLOBAL"] = true }
CTA_CHANNEL_ANNOUNCE = "LookingForGroup"
CTA_JOINED = "Joined"
...
CTA_TRIGGER_LIST = {
  ...
  ["CLASSES"] =
  {
    ["DRUID"] = { "druid", "drood", "dr00d", "driud", "feral", " cat", },
    ...
    ["HEALER"] = { "healer", "heals", },
    ["TANK"] = { "tank", " tanks", "bear", "guardian", },
    ["DAMAGE"] = { "damage", "dps", "dmg", "feral", "caster", "ranged?", "mdps", "rdps", },
    ["RANDOM"] = { "random", },
  },

  ["SPAM"] =
  {
    "channel","lol","chuck","norris","lmao","lmfao","rofl",
    "guild","wts","wtb","stfu","ignore","enchant","noob",
    "nub","n00b","vin","recruit","trogdoor","\.com","res","reserved",
  },
  ...
  ["GOAL"] =
  {
    ...
    ["SCHOLOMANCE"] = { " scholo", " scholomance", "kirtonos", },
    ...
    ["UBRS"] = { "upper *.spire", "upper *.blackrock", "ubrs", "urbs", "jed", "rend", },
